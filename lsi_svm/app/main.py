...
if __name__ == '__main__':
    #for f in LoadFolders('E:\\xwk\\数据\\清华大学数据集\\THUCNews\\THUCNews\\财经/'):
    #for f in LoadFolders('E:\\xwk\\数据\\清华大学数据集\\THUCNews\\THUCNews'):
     #   print(f)
    #current_dir = 'E:\\xwk\\数据\\清华大学数据集\\THUCNews\\THUCNews\\财经\\'
    #for content in FileUtil.read_file_by_dir(current_dir):
        # 注意上面的cut_all选项，如果cut_all=False， 则会列出最优的分割选项； 如果cut_all=True, 则会列出所有可能出现的词
    #    convert_doc_to_wordlist(content, False)
